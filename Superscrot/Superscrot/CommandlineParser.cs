...
/// </summary>
/// <remarks>A parameter that has no associated value returns an empty string, rather than null 
/// which is also used for non-existing values. (See http://msdn.microsoft.com/en-us/library/4ba5htte.aspx) </remarks>
public class CommandlineParser
{
  ...
  /// <summary>
  /// Gets or sets a list of supported characters or strings that indicate the value of a parameter.
  /// </summary>
  ...
  /// <summary>
  /// Returns the internally used NameValueCollection for storing the parameters and their values.
  /// </summary>
  ...
  /// </summary>
  /// <param name="args">A string array of parameters as provided by void Main()</param>
  ...
  /// <summary>
  /// Returns the value that belong to the specified parameter. Use the method GetValues on the property Items for all values.
  /// </summary>
  ...
  /// <summary>
  /// Returns whether the beginning of this string matches any of the specified strings.
  /// </summary>
  /// <param name="s">The string to check.</param>
  /// <param name="values">The string array that contains the values to compare.</param>
  /// <returns>True if any of the specifies strings matches the beginning of the string, false otherwise.</returns>
