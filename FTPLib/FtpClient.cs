...
namespace FTP
{
    ...
    public class FtpClient
    {
        ...
        /// </summary>
        /// <param name="hostname">The hostname or IP address of the FTP server.</param>
        /// <param name="port">The port that the FTP server runs on (usually 21).</param>
        ...
        /// <summary>
        /// Executes a common FTP method on the server that requires only a path and returns the status code.
        /// </summary>
        /// <param name="path">The relative path to the file or folder on the server.</param>
        ...
        /// <summary>
        /// Executes a common FTP method on the server that requires only a path and returns the status description.
        /// </summary>
        /// <param name="path">The relative path to the file or folder on the server.</param>
        /// <param name="method">The WebRequestMethods.Ftp method to execute</param>
        ...
        /// </summary>
        /// <param name="path">The relative path to the file on the server to download.</param>
        /// <param name="destination">The stream that the downloaded data will be written to.</param>
        ...
        /// </summary>
        /// <param name="serverpath">The relative path to the file on the server.</param>
        ...
        /// </summary>
        /// <param name="path">The relative path to the file on the server to delete.</param>
        /// <returns>True if the operation succeeded, false otherwise.</returns>
        ...
        /// </summary>
        /// <param name="path">The relative path to the folder on the server to create.</param>
        /// <returns>True if the operation succeeded, false otherwise.</returns>
        ...
        /// </summary>
        /// <param name="path">The relative path to the folder on the server to delete.</param>
        /// <returns>True if the operation succeeded, false otherwise.</returns>
        ...
        /// </summary>
        /// <param name="path">The relative path to the file or folder on the server to rename.</param>
        /// <param name="target">The new name of the file or folder to be renamed.</param>
        /// <returns>True if the operation succeeded, false otherwise.</returns>
