...
namespace FTP
{
    ...
    {
        /// <summary>Unix file system permissions</summary>
        public UnixFilePermissions Permissions;

        /// <summary>Number of hardlinks (or whatever that number is)</summary>
        public int HardLinkCount;

        /// <summary>The owner of the file</summary>
        public string Owner;

        /// <summary>The group of the file</summary>
        public string Group;

        /// <summary>The size of the file in bytes</summary>
        public long Size;

        /// <summary>The modification date of the file</summary>
